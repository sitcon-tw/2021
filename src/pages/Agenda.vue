<template>
	<div id="agenda">
		...
		<article>
			...
			投票資格：於 4/9 (五) 23:59 前取得 2021
			年會門票的與會者（不分票種）、2021 年會志工、2021 年會講者
		</article>
		<article>
			【注意事項】
			<ol class="vote rule" start="0" type="1">
				...
				<li>
					三個議程種類（Espresso、Double Espresso 與
					Presentation）可各選擇投給 1 個議程。
				</li>
				<li>
					若同一議程種類選擇超過一個議程，或不選擇任何議程，視為無效票。各個議程種類的選票有效性互相獨立，無效票不影響其他議程種類的選票認定，舉例來說，若
					Espresso 選擇 2 個議程、Double Espresso 選擇 1
					個議程、Presentation 選擇 0 個議程，則 Double Espresso
					的部分為有效票，其他二種議程為無效票。
				</li>
				<li>
					此投票表單使用 Google
		...
		<Popup class="agendaPopup" id="individual-agenda">
