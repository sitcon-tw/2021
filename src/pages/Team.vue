<template>
    <div id="team">
        <article class="introuct">
            <ArticleParagraph>
                <p>
                    SITCON 年會每年皆是許多志工奉獻時間與精神所舉辦，沒有大家的付出，就不可能回有如此內容豐富且高品質的年會，
                    希望大家在參加之餘，也不要忘記背後工作人員的付出。
                </p>
                <p>
                    若你對參與 SITCON 年會的籌備有興趣，歡迎填寫跳坑表單或是關注 SITCON 的郵件論壇，明年的籌備開始時，
                    你就會收到相關的資訊！
                </p>
            </ArticleParagraph>
        ...
        <article class="team_list">
            <section v-for="group in team" class="group">
                ...
                <p>{{group.intro}}</p>
                 <img
                    class="group-img"
                    :src="require(`../assets/images/teams/${getTeamImg(group.name)}.svg`)"
                />
...
export default class Team extends Vue {
    ...
    private getTeamImg (name: string): string {
        switch (name) {
            case '總召組':
                return 'gen';
            case '行政組':
